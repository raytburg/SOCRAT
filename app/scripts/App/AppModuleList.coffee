...
module.exports = class AppModuleList
  ...
  ,
    require 'scripts/analysis/MyModule.module.coffee'
  ,
    require 'scripts/analysis/MyModuleInit.service.coffee'
  ,
    require 'scripts/analysis/MyModuleMsgService.service.coffee'
  ,
    require 'scripts/analysis/MyModuleMyService.service.coffee'
  ,
    require 'scripts/analysis/MyModuleRunBlock.run.coffee'
  ,
